...
func (c *Client) FindCatFact(ctx context.Context) (facts.Diversity, error) {
	var response struct {
	...
	if err != nil {
		return facts.Diversity{}, eris.Wrap(err, "creating request for cat facts failed")
	}

	res, err := c.httpClient.Do(req)
	if err != nil {
		if err != nil {
			return facts.Diversity{}, eris.Wrap(err, "request for cat facts failed")
		}
	}
